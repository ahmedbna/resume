...
const socialLinks = [
  {
    name: 'GitHub',
    url: 'https://github.com/ahmedbna', // Replace with your GitHub URL
    icon: icons.gitHub,
  },
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/ahmedbna/', // Replace with your LinkedIn URL
    icon: icons.linkedin,
  },
  {
    name: 'X (Twitter)',
    url: 'https://x.com/ahmedbnaa', // Replace with your X URL
    icon: icons.x,
  },
  {
    name: 'Email',
    url: 'mailto:hi@ahmedbna.com', // Replace with your email
    icon: icons.email,
  },
];
...
export const HeroSection = () => {
  ...
  return (
    <section className='w-full min-h-screen flex flex-col justify-center items-center pt-32'>
      <div className='w-full flex flex-col items-center justify-center gap-4 mx-auto text-center mb-8'>
        <Image
          height={200}
          width={200}
          alt={'BNA'}
